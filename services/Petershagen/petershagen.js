...
let petershagen = async () => {
  try {
    ...
    await page.goto("https://bad-hopfenberg.de/stellenangebote/", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    const jobLinks = await page.evaluate(() => {
      return Array.from(document.querySelectorAll("a.elementor-accordion-title")).map(
        (el) => el.href
      );
    });
