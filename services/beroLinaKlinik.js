    ...
    try {
        ...
        for (const urls of allJobs) {
            ...
            const address = await page.evaluate(() => {
                let adr = document.querySelector('.news-single-item.news-cat-Berolina.Klinik > div > p b')
            ...
            const cell = await page.evaluate(() => {
                ...
                let text = Array.from(document.querySelectorAll('.news-single-item.news-cat-Berolina.Klinik'))
            ...
            const email = await page.evaluate(() => {
                ...
                let text = Array.from(document.querySelectorAll('news-single-item.news-cat-Berolina.Klinik > div > p font')).map(el => el.innerText);
