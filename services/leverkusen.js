...
let good = async () => {
  try {
    ...
    await page.goto("https://www.st-josef-leverkusen.de/karriere/stellenangebote",
     {
      waitUntil: "load",
      timeout: 0,
    });
 ...
 if (link1) {
   ...
   job.link = jobLink
      ...
      let link = await page.evaluate(() => {
        return document.querySelector("#c4202 > div > div > div > div > div.btn-toolbar > a:nth-child(3)").href;
      });
      job.link = link
