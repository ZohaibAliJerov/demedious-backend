...
let karankenhaus = async () => {
  try {
    ...
    const jobLinks = await page.evaluate(() => {
        let loadMore = document.querySelector(".button-more.load-list")
        loadMore.click();
      return Array.from(document.querySelectorAll("div.job-offers-list > ul > li > a")).map(
        (el) => el.href
      );
    });
