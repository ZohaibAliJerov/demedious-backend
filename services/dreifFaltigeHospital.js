...
let gfo_kliniken = async () => {
  try {
    ...
    await page.goto("https://dreifaltigkeits-hospital.de/ausbildung-karriere/aerztlicher-dienst/aktuelle-stellenangebote/", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    //   if(tit){
        let title = await page.evaluate(() => {
          let ttitle = document.querySelector("#c273 > div > div > div.news-text-wrap > p > span.big");
