...
let serverinskloesterchen = async () => {
  try {
    ...
    for (let jobLink of allJobLinks) {
      let job = {
        title: "",
        location: "50678 Cologne",
        hospital: " Augustinians gGmbH",
        city: "Cologne ",
        link: "",
        level: "",
        email: "",
    ...
    return document.body.innerText.match(/\w+\@\w+.\w+/) || "N/A";
      ...
      let link = await page.evaluate(()=>{
          let lnk = document.querySelector("a.button-jetzt-bewerben");
...
export default serverinskloesterchen;
