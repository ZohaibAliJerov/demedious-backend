...
let gfo_kliniken = async () => {
  try {
    ...
    await page.goto("https://klinik-am-ring.de/klinik-am-ring/job-und-karriere/", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    for (let jobLink of jobLinks) {
      ...
      job.location = await page.evaluate(() => {
        return document.body.innerText.match(/[a-zA-Z-.üö]+ \d+\w+ [\n]\d+ [a-zA-Z-.üö]+|[a-zA-Z-.üö].+[\n]\d+ [a-zA-Z-.üö]+ [a-zA-Z-.üö]+|[a-zA-Z-.üö].+[\n]\d+ [a-zA-Z-.üö].+|[a-zA-Z-.üö].+[\n][\n]\d+ [a-zA-Z-.üö].+/) || ""
      });
