  ...
  try {
    ...
    return document.body.innerText.match(/\w+.\w+\@\w+.\w+/) || "N/A";
      ...
      let link = await page.evaluate(() => {
        let lnk = document.querySelector("body > div.container > div > div.sidebar.col-xs-12.col-sm-12.col-md-4 > div > div.apply.col-xs-12.col-sm-6.col-md-12 > div > a");
