...
let gfo_kliniken = async () => {
  try {
    ...
    await page.goto("https://www.badoexen.de/klinik/stellenangebote.html", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    const jobLinks = await page.evaluate(() => {
      return Array.from(
        document.querySelectorAll("ul.list-unstyled.ul-styles.ul-small > li > a")
      ).map((el) => el.href);
    });
