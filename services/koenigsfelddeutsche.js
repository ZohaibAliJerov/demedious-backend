...
let gfo_kliniken = async () => {
  try {
    ...
    await page.goto("https://koenigsfeld.deutsche-rentenversicherung-reha-zentren.de/subsites/Koenigsfeld/de/Navigation/Service/Stellenangebote/Stellenangebote_node.html", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    const jobLinks = await page.evaluate(() => {
      return Array.from(
        document.querySelectorAll("tbody > tr > td > a")
      ).map((el) => el.href);
    });
    ...
    for (let jobLink of jobLinks) {
      let job = {
        title: "",
        location: "",
        hospital: "Klinik Königsfeld der Deutschen Rentenversicherung Westfalen",
        link: "",
        level: "",
        position: "",
        city: "Ennepetal",
