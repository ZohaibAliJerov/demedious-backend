    ...
    for (let jobLink of jobLinks) {
      ...
      await page.waitForTimeout(1000);
        ...
        let title = await page.evaluate(() => {
          let ttitle = document.querySelector("h1.h2.util-uppercase.util-theme-red");
      ...
      job.email = await page.evaluate(() => {
        return document.body.innerText.match(/[a-zA-Z-.]+@[a-zA-Z-.]+|[a-zA-Z-.]+[(]\w+[)][a-zA-Z-.]+/) || "karriere@wicker.de"
      });
