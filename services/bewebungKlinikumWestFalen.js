...
let gfo_kliniken = async () => {
  try {
    ...
    await page.goto("https://bewerbung.klinikum-westfalen.de/angebote.aspx?bInstitution=1", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    for (let jobLink of jobLinks) {
      ...
      await page.waitForTimeout(1000);
        ...
        let title = await page.evaluate(() => {
          let ttitle = document.querySelector(".job-eintrag-beschreibung-detail-top > h1");
