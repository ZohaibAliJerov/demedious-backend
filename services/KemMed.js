...
let gfo_kliniken = async () => {
  try {
    ...
    await page.goto("https://kem-med.com/ausbildung-und-karriere/karriere/stellenmarkt/aerztliche-stellen/", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    const jobLinks = await page.evaluate(() => {
      return Array.from(
        document.querySelectorAll(".bite_main > p > a")
      ).map((el) => el.href);
    });
    ...
    //   if(tit){
      ...
      job.email = await page.evaluate(() => {
        return document.body.innerText.match(/[a-zA-Z-.]+@[a-zA-Z-.]+|[a-zA-Z-.]+[(]\w+[)][a-zA-Z-.]+/) || "Essen"
      });
