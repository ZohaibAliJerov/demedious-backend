...
let knappschaftk = async () => {
  try {
    ...
    await page.goto("https://bewerbung.kk-bottrop.de/angebote.aspx?bInstitution=1", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    for (let jobLink of jobLinks) {
      ...
      let email = await page.evaluate(()=>{
        let eml = document.querySelector("a.RichTextExtLinkMailTo.ExternalLink")
        return eml ? eml.href : "";
      })
