  ...
  try {
    ...
    for (let jobLink of jobLinks) {
      ...
      let title = await page.evaluate(() => {
        let ttitle = document.querySelector("div.content-element.text > h3");
      ...
      let link = await page.evaluate(() => {
        let lnk = document.querySelector(".content-element.text.design-box.yellow > p > a");
        return lnk ? lnk.href : "";
      });
      job.link = link;
      allJobs.push(job);
