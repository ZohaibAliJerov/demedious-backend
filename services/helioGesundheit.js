  ...
  try {
    ...
    for (const url of allJobs) {
      ...
      let email = await page.evaluate(() => {
        let text = document.querySelector(".content-block-list__container");
      ...
      let location = await page.evaluate(() => {
       ...
       return text ? text.innerText.match(/[a-zA-Z]+\s+[a-zA-Z]+\s+[a-zA-Z]+\W[a-zA-Z,]+\s[a-zA-Z]+\s[a-zA-Z]+\W[a-zA-Z]+\s[a-zA-Z]+\W[a-zA-Z]+\s\d,\s\d+\s[a-zA-Z]+\W[a-zA-Z]+/g) : null;
      });
