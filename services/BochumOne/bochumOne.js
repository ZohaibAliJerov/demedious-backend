...
let bochumOne = async () => {
  try {
    ...
    await page.goto("https://bewerbung.kk-bochum.de/angebote.aspx?bInstitution=1", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    for (let jobLink of jobLinks) {
      let job = {
        ...
        city: "Bochum",
        hospital: "Universitätsklinikum Knappschaftskrankenhaus Bochum",
        link: "",
        level: "",
        position: "",
        email: "",
