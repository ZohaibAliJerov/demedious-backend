  ...
  try {
    ...
    await page.waitForSelector("a.c-link.u-icon.u-icon.u-icon--phone")
      let cell = await page.evaluate(()=>{
        let num = document.querySelector("a.c-link.u-icon.u-icon.u-icon--phone")
    ...
    let email  = await page.evaluate(()=>{
      ...
      return text ? text.innerText.match(/[a-zA-Z0-9]+@[a-zA-Z0-9]+.[a-zA-Z0-9]+-[a-zA-Z0-9]+.[a-zA-Z0-9]+/g) : null; 
    })
    ...
    let location = await page.evaluate(()=> {
     let text =  document.querySelector(".o-grid__row")
      ...
      return text ? text.innerText.match(/[a-zA-Z0-9]+ [a-zA-Z0-9]+[\n\][a-zA-Z0-9]+ [a-zA-Z0-9]+ \d+[\n][\n]\d+ [a-zA-Z0-9]+/) : null;
    })
    let applyLink = await page.evaluate(()=>{
      let text = document.querySelector("a.c-button.c-button--main.c-button--large")
