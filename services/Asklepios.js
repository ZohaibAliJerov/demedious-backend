...
let gfo_kliniken = async () => {
  try {
    ...
    await page.goto("https://www.asklepios.com/sankt-augustin/unternehmen/arbeiten-bei-asklepios/stellenangebote/", {
      waitUntil: "load",
      timeout: 0,
    });
    ...
    const jobLinks = await page.evaluate(() => {
      return Array.from(
        document.querySelectorAll("a.link-box")
      ).map((el) => el.href);
    });
    ...
    for (let jobLink of jobLinks) {
      let job = {
        title: "",
        location: "",
        hospital: "ASKLEPIOS Kinderklinik Sankt Augustin",
        link: "",
        level: "",
        position: "",
        city: "Sankt Augustin",
